...
public class WuLineDrawer implements LineDrawer {
    ...
    public Color colorOne(double grad, int var) {
        return var == 1 ? new Color(150, 70, 20, (int) (255 * grad)) : new Color(150, 70, 20, (int) (255 * (1 - grad)));
    }

    public Color colorTwo(double grad, int var) {
        return var == 1 ? new Color(0, 70, 20, (int) (255 * grad)) : new Color(0, 70, 20, (int) (255 * (1 - grad)));
    }
